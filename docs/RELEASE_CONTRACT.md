...
private index, credentials, license data, private host address, personal home
path, raw conversation, or unsanitized AEDT log. Public fixtures must be
synthetic and independently redistributable.
